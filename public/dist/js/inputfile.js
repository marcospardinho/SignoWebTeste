        ...
        if (isSuccess) { //yes
            ...
            reader.onload = function (e) {
                if (extension == 'pdf'){
                	...
                	$(input).closest('.fileUpload').find(".icon").attr('src','https://image.flaticon.com/icons/png/512/732/732224.png');
                }
                else if (extension == 'ppt'){
                	$(input).closest('.fileUpload').find(".icon").attr('src','https://image.flaticon.com/icons/png/512/732/732224.png');
                }
                else if (extension == 'xls'){
                    $(input).closest('.fileUpload').find(".icon").attr('src','https://image.flaticon.com/icons/png/512/732/732220.png');
                }
