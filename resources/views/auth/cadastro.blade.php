...
<head>
    ...
    <!-- Style -->
    <link rel="stylesheet" href="{{ url('dist/css/styleCad.css') }}">
    ...
    <script src="{{ url('dist/js/bladeCadastro.js') }}"></script>
...
<body>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-7 py-5">
                        ...
                        <form action="{{ route('storeCad') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
    ...
    <script src="{{ url('dist/js/mainCad.js') }}"></script>
